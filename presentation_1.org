...
\begin{align*}
\onslide<2->{    & ( \lambda \color<3->{orange}{x} . &    \lambda y                     .     & \color<3->{orange}{x} & y                     & ) & \color<3->{orange}{a} & & b } \\
\onslide<4->{\to &                                   & ( \lambda \color<5->{cyan}{y}    .     & \color{orange}{a}     & \color<5->{cyan}{y}   & ) &                       & & \color<5->{cyan}{b} } \\
\onslide<6->{\to &                                   &                                        & \color{orange}{a}     & \color{cyan}{b}       &   &                       & & }
\end{align*}

@@beamer:<1->@@Parentheses are not part of the grammer? See next slide... :)
